...
<div class="row">
      <div class="col-md-6">
        <div class="form-group <?php echo e($errors->has('title') ? 'has-error' : ''); ?>">
          ...
          <input type="text" id="movietitle" name="movietitle" class="form-control" placeholder="Enter movietitle" value="<?php echo e(old('movietitle')); ?>">
    ...
    <div class="container">
      ...
      <?php echo e(Form::text('movietitle'),array('required')); ?>
